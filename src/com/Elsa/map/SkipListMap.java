package com.Elsa.map;

import com.Elsa.exception.IteratorStateErrorException;
import com.Elsa.iterator.Iterator;
...
public class SkipListMap<K,V> extends AbstractMap<K,V>{
    ...
    public static class Node<K,V> implements EntryNode<K,V>{
        K key;
        V value;
        Node<K,V> left;
        Node<K,V> right;
